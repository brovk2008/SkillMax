...
export function AchievementsGrid({ stats }: Props) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-2xl border border-slate-200 bg-gradient-to-r from-fuchsia-50 via-teal-50/50 to-white p-6 shadow-sm">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="space-y-1">
            <span className="inline-flex items-center gap-1 text-xs font-semibold uppercase tracking-wider text-fuchsia-800 bg-fuchsia-100/80 px-2.5 py-0.5 rounded-full">
              <ShieldCheck className="h-3.5 w-3.5 text-fuchsia-700" />
          ...
          <div className="flex items-center gap-3 bg-white border border-slate-200 rounded-xl p-4 shadow-xs shrink-0">
            ...
            <div>
              ...
              <p className="text-2xl font-extrabold text-slate-900">{totalPoints} <span className="text-xs font-semibold text-fuchsia-600">PTS</span></p>
            </div>
          </div>
        </div>
      </div>
          ...
          return (
            <div
              ...
              className={`rounded-xl border p-4 transition-all flex flex-col justify-between ${
                ach.unlocked
                  ? 'border-fuchsia-200 bg-white shadow-xs hover:border-fuchsia-300'
                ...
                <div className="h-1.5 w-full rounded-full bg-slate-200 overflow-hidden">
                  <div
                    className={`h-full transition-all duration-300 ${
                      ach.unlocked ? 'bg-fuchsia-600' : 'bg-slate-400'
                    }`}
