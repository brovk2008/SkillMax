            ...
            >
              ...
              <div className="mt-6 border-t border-slate-100 pt-3 grid grid-cols-2 gap-2 text-xs">
                ...
                <div>
                  ...
                  <p className="font-bold text-emerald-600">{item.monEarned.toFixed(2)} MON</p>
                </div>
              </div>
            </div>
          )
              ...
              {leaderboard.map((item, idx) => (
                <tr key={item.id} className="hover:bg-slate-50/80 transition-colors">
                  ...
                  <td className="px-6 py-4">
                    <Link href={`/profile/${item.username}`} className="font-semibold text-slate-900 hover:text-emerald-600">
                      {item.full_name}
                    </Link>
