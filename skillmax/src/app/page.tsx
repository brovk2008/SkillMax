      ...
      <section className="mx-auto max-w-6xl px-4">
        <div className="flex flex-wrap items-center justify-between gap-3 rounded-xl border border-slate-200 bg-slate-50/80 px-4 py-2.5 text-xs text-slate-600 shadow-xs">
          <div className="flex items-center gap-2">
            ...
            <span className="font-mono text-emerald-800 font-semibold bg-emerald-100/70 px-2 py-0.5 rounded">Chain 10143</span>
          </div>
        ...
        <div className="rounded-2xl border border-slate-200 bg-gradient-to-b from-slate-50/90 to-slate-50/30 p-8 md:p-12 text-slate-900 shadow-xs space-y-6">
          <div className="max-w-3xl space-y-4">
            <div className="flex flex-wrap items-center gap-2">
              <span className="inline-flex items-center gap-1.5 rounded-full bg-emerald-100/80 px-3 py-1 text-xs font-semibold text-emerald-900 border border-emerald-200">
            ...
            <form action="/explore" method="GET" className="pt-2 flex flex-col sm:flex-row gap-2.5">
              <div className="flex-1 flex items-center bg-white border border-slate-300 rounded-xl px-4 py-3 text-slate-900 shadow-xs focus-within:border-emerald-600 focus-within:ring-2 focus-within:ring-emerald-500/20">
              ...
              <button
                type="submit"
                className="rounded-xl bg-emerald-600 px-6 py-3 text-xs sm:text-sm font-bold text-white hover:bg-emerald-700 transition-colors shadow-xs shrink-0 flex items-center justify-center gap-2"
              >
            ...
            <div className="flex flex-wrap items-center gap-3 pt-2">
              ...
              >
                <HandHeart className="size-3.5 text-emerald-400" />
          ...
          {CATEGORY_NAMES.map((cat) => {
            ...
            return (
              <Link
                ...
                className="flex flex-col items-center justify-center rounded-2xl border border-slate-200 bg-white p-4 text-center hover:border-emerald-500 hover:shadow-md hover:-translate-y-0.5 transition-all duration-200 group shadow-xs"
              >
                <div className="size-12 rounded-2xl bg-slate-100 flex items-center justify-center mb-2.5 group-hover:bg-emerald-50 transition-colors">
        ...
        <div className="rounded-2xl border border-slate-200 bg-slate-50/50 p-6 md:p-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="flex items-start gap-3.5">
              <div className="size-10 rounded-xl bg-emerald-100/80 flex items-center justify-center text-emerald-800 shrink-0 shadow-xs">
