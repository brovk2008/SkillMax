        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6">
          <div className="flex items-center gap-4">
            <img
              ...
              className="h-20 w-20 rounded-full object-cover border-2 border-fuchsia-500 shadow-sm shrink-0"
            />
            <div className="space-y-1">
              <div className="flex items-center gap-2">
                <h1 className="text-2xl font-extrabold tracking-tight text-slate-900">{profile.full_name}</h1>
                <span className="inline-flex items-center gap-1 text-[11px] font-semibold text-fuchsia-700 bg-fuchsia-100/80 px-2 py-0.5 rounded-md">
              ...
              {profile.headline && (
                <p className="text-xs font-semibold text-fuchsia-700">{profile.headline}</p>
              )}
          ...
          <div className="flex gap-2 shrink-0">
            <Link
              href="/skills/new"
              className="rounded-lg bg-fuchsia-600 px-4 py-2 text-xs font-bold text-white hover:bg-fuchsia-700 shadow-xs"
            >
              + Offer Skill
            </Link>
            <Link
        ...
        {skillTags.length > 0 && (
          <div className="pt-3 border-t border-slate-200/80 flex items-center gap-2 flex-wrap">
            <span className="text-xs font-semibold text-slate-500 uppercase tracking-wider flex items-center gap-1">
              <Tag className="h-3 w-3 text-fuchsia-600" />
              Skill Tags:
            </span>
            {skillTags.map((tag) => (
              <span
        ...
        <div className="space-y-4">
          ...
          {profile.wallet_address ? (
            ...
            <div className="rounded-xl border border-dashed border-slate-300 p-4 text-center">
              ...
              <Link href="/settings" className="text-xs font-semibold text-fuchsia-600 hover:underline">
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <Link href="/skills/new" className="text-xs font-semibold text-fuchsia-700 hover:underline">
                + Create Listing
              </Link>
            </div>
